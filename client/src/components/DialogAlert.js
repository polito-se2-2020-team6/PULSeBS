    ...
    return (
      <>
        ...
        <Modal show={show} onHide={handleClose} id="modId">
          ...
          <Modal.Body>
            Are you sure you want to delete the lecture of {props.courseName} at{" "}
            {moment(props.startTS).format("DD/MM/YYYY HH:mm")}?
          </Modal.Body>
          <Modal.Footer>
            ...
            <Button
              ...
              onClick={() => {
                handleClose();
                props.onConfirm(props.lectureId);
              }}
            >
              Yes, I am
            </Button>
    ...
    return (
      <>
        ...
        <Modal show={show} onHide={handleClose} id="modId1">
          ...
          <Modal.Body>
            Are you sure you want to turn the lecture of {props.courseName} at{" "}
            {moment(props.startTS).format("DD/MM/YYYY HH:mm")}?
          </Modal.Body>
          <Modal.Footer>
